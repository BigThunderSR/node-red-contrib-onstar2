...
export declare enum CommandResponseStatus {
    success = "success",
    failure = "failure",
...
export declare enum AlertRequestAction {
    Honk = "Honk",
    Flash = "Flash"
}
export declare enum AlertRequestOverride {
    DoorOpen = "DoorOpen",
...
export declare enum DiagnosticRequestItem {
...
export declare enum ChargingProfileChargeMode {
...
export declare enum ChargingProfileRateType {
    Offpeak = "OFFPEAK",
    Midpeak = "MIDPEAK",
    Peak = "PEAK"
}
...
export declare enum ChargeOverrideMode {
