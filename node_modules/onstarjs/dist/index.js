...
var appId = "OMB_CVY_AND_5U0";
var appSecret = "NZbzagcuvTceQScyRTb6tiE78qzfBJVnHV7u";
...
class TokenHandler {
    ...
    createUpgradeJWT() {
        ...
        return jwt__default["default"].sign(payload, onStarAppConfig.appSecret, { noTimestamp: true });
    }
    createAuthJWT() {
        const payload = {
            client_id: onStarAppConfig.appId,
    ...
    decodeToken(token) {
        const authToken = jwt__default["default"].verify(token, onStarAppConfig.appSecret);
    ...
    generateNonce() {
        ...
        const shaHex = crypto__default["default"].createHash("sha256").update(uuidHex).digest("hex");
...
(function (DiagnosticRequestItem) {
    ...
    DiagnosticRequestItem["EnergyEfficiency"] = "ENERGY EFFICIENCY";
...
class OnStar {
    ...
    static create(config) {
        const requestService = new RequestService(config, new TokenHandler(config), axios__default["default"]);
