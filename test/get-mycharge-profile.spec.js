...
describe('get-mycharge-profile', function () {
  ...
  it('Should be loaded', function (done) {
    var flow = [
      { id:"n1",type:"get-mycharge-profile",name:"Get Charging Profile",onstar2:"Onstar Config",wires:[["n2"],["n3"]] }
    ];
    helper.load(onStar, flow, function () {
      var n1 = helper.getNode("n1");
      try {
        n1.should.have.property('name', 'Get Charging Profile');
        n1.should.have.property('type', 'get-mycharge-profile');
        done();
      } catch(err) {
        done(err);
      }
  ...
  it('Should output 401 error due to not having valid credentials', function (done) {
    var flow = [
      { id:"n1",type:"get-mycharge-profile",name:"Get Charging Profile",onstar2:"17dfaade45168b46",wires:[["n2"],["n3"]] },
