...
describe('alert-myvehicle Node', function () {
  ...
  it('Should output error due to action.split', function (done) {
    var flow = [
      ...
      { id:"17dfaade45168b46",type:"onstar2",carname:"TestCar1",username:"homer@simpson.com",password:"Doh!",pin:"1234",vin:"3N1AB6AP7BL687841",deviceid:"90892463-2243-4cd7-9144-3492df757ff2",totp:"TESTTOTP",checkrequeststatus:"true",requestpollingtimeoutseconds:"90",requestpollingintervalseconds:"6" },
      { id: "n2", type: "helper" }
    ];
    helper.load(onStar, flow, function () {
